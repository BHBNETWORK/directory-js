...
const main = () => {
	...
	const aBNAddresses = bitcore.crypto.BN.fromString('115792089237316195423570985008687907852837564279074904382605163141518161494336');
	...
	const seconds = aBNAddresses.div(globalHashingPower);
	...
	console.log(JSON.stringify({
		addresses: aBNAddresses.toString(),
